"""Offline Candidate Table records, contrasts and diagnostic summaries."""
...
from safe_rl.accvp.modeling.model import ACCVPPredictor
from safe_rl.accvp.contracts.schema import file_sha256, read_json, stable_hash
from safe_rl.accvp.planning.selection import select_viability_action
...
def load_models_from_checkpoint(config: Any, checkpoint: str | Path, torch: Any) -> list[Any]:
    ...
    if not kwargs:
        from safe_rl.accvp.modeling.model import model_kwargs_from_config
