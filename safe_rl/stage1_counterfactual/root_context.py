"""Root-state capture, serialization and restoration for branching."""
...
from safe_rl.accvp.contracts.protocol import scenario_config_hash
...
def capture_root_context(
    ...
    *,
    ...
    scenario_hash = scenario_config_hash(env.config)
