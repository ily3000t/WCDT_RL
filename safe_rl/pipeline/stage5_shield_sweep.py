...
def _variant_report(base: dict, candidate: dict) -> dict[str, Any]:
    ...
    return {
        "metrics": {
            ...
            "proxy_collision_count": metrics.get("proxy_collision_count", 0),
            "safety_violation_count": metrics.get("safety_violation_count", 0),
            "taper_miss_rate": metrics.get("taper_miss_rate", 0.0),
            "taper_miss_count": metrics.get("taper_miss_count", 0),
            "min_distance_le_collision_threshold_count": metrics.get("min_distance_le_collision_threshold_count", 0),
            ...
            "completion_time_p95": metrics.get("completion_time_p95", 0.0),
            "ego_speed_mean": metrics.get("ego_speed_mean", 0.0),
            "ego_speed_p10": metrics.get("ego_speed_p10", 0.0),
            "hard_brake_rate": metrics.get("hard_brake_rate", 0.0),
            ...
            "emergency_fallback_rate": metrics.get("emergency_fallback_rate", 0.0),
            "mean_emergency_fallbacks": metrics.get("mean_emergency_fallbacks", 0.0),
            "emergency_fallback_count": metrics.get("emergency_fallback_count", 0),
